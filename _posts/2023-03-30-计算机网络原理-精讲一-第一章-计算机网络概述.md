...
### 5.2. *<font color='red' style='background-color:' size=''>OSI</font>*(Open System Interconnection)参考模型(7 层)  
...
2.  在物理层的两个端点进行物理通信， 这种通信称为<font color='red' style='background-color:' size=''>实通信</font>。
