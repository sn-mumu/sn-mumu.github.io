...
1. <font color='red' style='background-color:' size=''>网络协议</font>是网络通信实体之间在数据交换过程中需要遵循的规则或约定  
2. 协议三要素： <font color='red' style='background-color:' size=''>语义、 语法、 时序</font>。
   + <font color='red' style='background-color:' size=''>语法</font>： 语法定义实体之间交换信息的格式与结构。
   + <font color='red' style='background-color:' size=''>语义</font>： 语义就是定义实体之间交换的信息中需要发送控制信息。
   + <font color='red' style='background-color:' size=''>时序</font>： 时序也称为同步， 定义实体之间交换信息的顺序以及如何匹配或适应彼此的速度。
...
####   二、 按<font color='red' style='background-color:' size=''>拓扑结构</font>分类：  
