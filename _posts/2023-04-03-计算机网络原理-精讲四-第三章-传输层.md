...
+ <font color='red' style='background-color:' size=''>慢启动</font>：<font color='red' style='background-color:' size=''> 阈值之前</font>的阶段称之为慢启动阶段， 每经过 RTT， 拥塞窗口大小加倍。

+ <font color='red' style='background-color:' size=''>拥塞避免</font>： <font color='red' style='background-color:' size=''>阈值之后</font>的阶段称之为拥塞避免阶段， 每经过 RTT， 拥塞窗口大小增加 1。  
