...
1. 场景：在业务系统中，有一张表（日志表），业务系统每天都会产生大量的日志数据，单台服务器的数据存储及处理能力是有限的，可以对数据库表进行拆分。
   ...
   ![image-20230302111759036](https://raw.githubusercontent.com/sn-mumu/cloud-storage/main/PicGo/2026/06/%E7%94%9F%E6%88%90%E8%B5%84%E6%BA%90%E4%B8%8D%E5%AD%98%E5%9C%A8%E5%9B%BE%E7%89%87.png)
...
2. MyCat-eye（MyCat-web）
   ...
   + 访问
     ...
     ```http
     GE https://192.168.88.1:8082/mycat
     ```
